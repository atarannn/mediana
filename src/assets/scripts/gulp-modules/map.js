...
function initMap() {
  ...
  const baseFolder = './assets/images/home/section-6/';
  let defaultMarkerSize = new google.maps.Size(133, 160);

  if (document.documentElement.clientWidth < 575) {
    var buildLogoSize = new google.maps.Size(60, 100);
  }
  const markersAdresses = {
    main: `${baseFolder}map-logo.svg`,
  };
  ...
  const markersData = [
    {
      ...
      position: { lat: 45.7991823, lng: 15.8542237 },
    },
  ];
